...
class Hyperparameters:
    ...
    def __init__(self, b_n_type=4, b_n_flow=-1, b_n_block=-1, b_n_squeeze=-
        1, b_hidden_ch=None, b_affine=True, b_conv_lu=2, a_n_node=-1,
        a_n_type=-1, a_hidden_gnn=None, a_hidden_lin=None, a_n_flow=-1,
        a_n_block=1, mask_row_size_list=None, mask_row_stride_list=None,
        a_affine=True, path=None, learn_dist=True, seed=1, noise_scale=0.6):
        """
    ...
    def save(self, path):
        ...
        with open(path, 'w') as f:
            json.dump(self.__dict__, f, indent=4, sort_keys=True, cls=
                NumpyEncoder)
