...
class TimeReport(object):
    ...
    def print_summary(self):
        ...
        print(
            'Elapsed time: {:02d}h-{:02d}m-{:02d}s,\t[Estimated] End: {:02d}:{:02d}:{:02d}-{}/{:02d}/{:02d},\tTotal: {:02d}h-{:02d}m-{:02d}s,\tRemain: {:02d}h-{:02d}m-{:02d}s'
            .format(eh, em, es, sttime.tm_hour, sttime.tm_min, sttime.
            tm_sec, sttime.tm_year, sttime.tm_mon, sttime.tm_mday, th, tm,
            ts, rh, rm, rs))
